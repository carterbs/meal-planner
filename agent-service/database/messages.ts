...
export class MessageRepository {
  ...
  async saveMessage(threadID: string, sender: string, content: string): Promise<MessageRecord> {
    const query = `
  ...
  async addMessage(threadID: string, sender: string, content: string): Promise<void> {
    const query = `
  ...
  async getMessagesForProtobuf(threadID: string): Promise<Array<{ thread_id: string; sender: string; content: string; created_at: string }>> {
    const query = `
  ...
  async addMessageLegacy(threadID: string, sender: string, message: string): Promise<ChatMessage> {
