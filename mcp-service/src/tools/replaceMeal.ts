...
import { ReplaceMealRequest, ReplaceMealResponse } from '@mealplanner/generated';
...
export function registerReplaceMeal(server: McpServer) {
    server.tool('replaceMeal', 'Replace a specific meal in the weekly meal plan. Use this after analyzing available meals and current plan to make an intelligent substitution. Consider effort levels (Monday: 0-2, Tue-Thu/Sat: 3-5, Sunday: 6-100), red meat limits (max 1 per week), and meal type compatibility.', {
