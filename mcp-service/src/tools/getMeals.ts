...
export function registerGetMeals(server: McpServer) {
    server.tool('getMeals', 'Fetch all available meals with detailed metadata including effort levels, meal types, red meat status, and last planned dates. Essential for making informed meal replacement decisions.', {
