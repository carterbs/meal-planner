...
2. Use the validate tool for all testing, linting, and building.  Run `yarn test|lint|build` before committing. Add meaningful tests that verify behavior, not just coverage.
...
- **Run all operations**: `yarn test|lint|build`
- **Target specific services**: `yarn test --service ui --service meal-service`
- **Verbose output**: `yarn test --verbose`
- **CI mode**: `yarn test --ci --json`
